...
local nonlinkedblue = surface.GetTextureID( "sprites/circular/portalstaticoverlay_1" )
local nonlinkedorange = surface.GetTextureID( "sprites/circular/portalstaticoverlay_2" )
local bluebordermat = surface.GetTextureID( "sprites/circular/portal_1_anims" )
local orangebordermat = surface.GetTextureID( "sprites/circular/portal_2_anims" )
local nonlinkedbluebeta = nonlinkedblue
local nonlinkedorangebeta = nonlinkedorange
local bluebetabordermat = bluebordermat
local orangebetabordermat = orangebordermat
